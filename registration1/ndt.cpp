...
main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("bunny_transformed_sac.pcd", *input_cloud) == -1)
    {
        PCL_ERROR("Couldn't read file bunny_transformed_sac.pcd \n");
        return (-1);
    }
    std::cout << "Loaded " << input_cloud->size() << " data points from bunny_transformed_sac.pcd" << std::endl;
    ...
    std::cout << "Filtered cloud contains " << filtered_cloud->size()
        << " data points from bunny_transformed_sac.pcd" << std::endl;
    //初始化正态分布变换（NDT）
...
*/
    ...
    init_matrix<<0.815905,0.569306,0.100948,-0.571533,
               -0.569183,0.821554,-0.0328553,0.399136,
               -0.101639,-0.030651,0.994349,0.0703133,
                0,0,0,1;
    result_mastrix=ndt.getFinalTransformation()*init_matrix;
